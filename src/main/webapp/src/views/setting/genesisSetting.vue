    ...
    <div class="viewBranchDialog">
                    ...
                    <el-row :gutter="30">
                        ...
                        <el-col :span="12">
                            <div class="witeness">
                                ...
                                <el-row
                                    v-for="(item,index) in genesisSetting.genesis_block_witnesses"
                                    :key="index"
                                >
                                    <el-button
        ...
        >
            <el-form
                ...
                label-position="left"
            >
                <el-form-item label="address" prop="address">{{ witenessForm.address }}</el-form-item>
                <el-form-item label="url" prop="url">{{ witenessForm.url }}</el-form-item>
                <el-form-item label="voteCount" prop="voteCount">{{ witenessForm.voteCount }}</el-form-item>
            </el-form>
        </el-dialog>
    </div>
</template>
